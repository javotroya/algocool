...
App.Render = function (view, element) {
...
App.Render404 = function () {
  $('#main').html('<h1 class="text-center my-3">404 Not found</h1>').append('<p class="text-center mb-4">Sorry, we tried so hard and got so far, but in the end, it didn\'t even matter...</p>').append("<p class=\"text-center\">\n\t\t<a class=\"btn btn-primary\" title=\"...until you are complete again\"\n\t\thref=\"".concat(sessionStorage.getItem('goBackURL'), "\">From where you came, you should remain...</a>\n\t</p>"));
};
...
App.Model.Movie = Backbone.Model.extend({
  url: function url() {
    return "https://yts.lt/api/v2/movie_details.json?movie_id=".concat(this.id);
  }
});
